...
import { Sprout, Mail, Lock, Eye, EyeOff, Sparkles, ArrowLeft } from 'lucide-react'
...
export default function AuthPage() {
  ...
  async function handleGoogleAuth() {
    ...
    try {
      ...
      setError(err.message || 'Erro ao conectar com Google. Verifique se o Google OAuth está configurado no Supabase.')
      setLoading(false)
    }
  }
